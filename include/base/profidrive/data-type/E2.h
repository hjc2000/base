...
namespace base::profidrive
{
	...
	public:
		...
		explicit E2(base::ReadOnlySpan const &span)
		{
			...
			int16_t e2 = base::big_endian_remote_converter.FromBytes<int16_t>(span);
			_value = base::Int64Fraction{e2, Factor()};
		}
		...
		/// @param value
		///
		explicit E2(base::Int64Fraction const &value)
		{
			_value = value;
		}
		...
		{
			return profidrive::E2{_value + right_value._value};
		}

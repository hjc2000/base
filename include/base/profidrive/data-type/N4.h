...
namespace base::profidrive
{
	...
	public:
		...
		explicit N4(base::ReadOnlySpan const &span)
		{
			...
			int32_t n4 = base::big_endian_remote_converter.FromBytes<int32_t>(span);
			_value = base::Int64Fraction{n4, Factor()};
		}
		...
		/// @param value
		///
		constexpr explicit N4(base::Int64Fraction const &value)
		{
			_value = value;
		}
		...
		constexpr base::Int64Fraction const &Value() const
		{
			return _value;
		}
		...
		{
			return profidrive::N4{_value + right_value._value};
		}

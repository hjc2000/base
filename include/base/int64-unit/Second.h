...
namespace base
{
	namespace int64_unit
	{
		/// @brief 秒
		class Second :
			public base::int64_unit::IUnit<Second>
		{
		private:
		...
		public:
			...
			explicit Second(base::Int64Fraction const &value)
			{
				_value = value;
			}
			...
			{
				_value = base::Int64Fraction{value.count()};
			}

			Second(std::chrono::milliseconds const &value)
			{
				_value = base::Int64Fraction{value.count()} / 1000;
			}

			Second(std::chrono::microseconds const &value)
			{
				_value = base::Int64Fraction{value.count()} / 1000 / 1000;
			}

			Second(std::chrono::nanoseconds const &value)
			{
				_value = base::Int64Fraction{value.count()} / 1000 / 1000 / 1000;
			}

			using base::int64_unit::IUnit<Second>::Value;

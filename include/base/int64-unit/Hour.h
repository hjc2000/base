...
#include "base/int64-unit/Minute.h"
...
namespace base
{
	...
	{
		class Hour :
			public base::int64_unit::IUnit<Hour>
		{
		private:
		...
		public:
			...
			explicit Hour(base::Int64Fraction const &value)
			{
				_value = value;
			}

			Hour(base::int64_unit::Second const &value)
			{
				base::int64_unit::Minute minute{value};
			...
			Hour(T const &value)
				: Hour(base::int64_unit::Second{value})
			{
			}
			...
			{
				base::int64_unit::Minute minute{_value * 60};
				return base::int64_unit::Second{minute};
			}
		};

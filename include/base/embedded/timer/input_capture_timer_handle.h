...
namespace base::input_capture_timer
{
	...
	/// @param value
	///
	void set_counter_period_preload_value(base::input_capture_timer::input_capture_timer_handle &self,
										  uint32_t value);
	...
	/// @param channel_id
	///
	void start_channel(base::input_capture_timer::input_capture_timer_handle &self,
					   uint32_t channel_id);
	...
	/// @param channel_id
	///
	void stop_channel(base::input_capture_timer::input_capture_timer_handle &self,
					  uint32_t channel_id);

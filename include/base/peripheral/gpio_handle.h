...
namespace base
{
	namespace gpio
	{
		...
		class gpio_handle;
		using sp_gpio_handle = std::shared_ptr<base::gpio::gpio_handle>;

		/* #region 打开函数 */

		sp_gpio_handle open_as_input_mode(base::gpio::PullMode pull_mode,
										  base::gpio::TriggerEdge trigger_edge);

		sp_gpio_handle open_as_output_mode(base::gpio::PullMode pull_mode,
										   base::gpio::DriveMode drive_mode);

		sp_gpio_handle open_as_alternate_function_mode(base::gpio::AlternateFunction af,

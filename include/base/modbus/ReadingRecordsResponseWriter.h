...
namespace base::modbus
{
	...
	public:
		ReadingRecordsResponseWriter(base::Span const &span)
			: _adu_writer(span)
		{
		}
		...
		{
			_adu_writer.WriteFunctionCode(base::modbus::function_code::ReadRecords());
		}
		...
		{
			return _adu_writer.WriteData(value, std::endian::big);
		}
